...
<p>&emsp;&emsp;2022-9-7 电脑真的没内存了，整不动虚拟环境了，决定在colab上尝试学习mmdetection。把DINO之前阅读笔记搬到知乎。精读模型剪枝论文。每日一扣√，我发现算法题如果是为了考虑复杂度的话，其实多敲几行代码就行了，我的思路都是如何利用循环让代码简洁，所以我反而废了更多脑子还做的更差？？？😅</p>
